...
export class AmigaRetroSunset {
    constructor() {
        ...
        this.cloudX = -50;
        this.cloudY = 45; // Tiefer gesetzt, um dem Logo mehr Luft zu geben
    ...
    drawMountainRange(ctx, width, horizon, points, color, scrollOffset, heightScale, isForeground = false) {
        ...
        for (let tile = 0; tile < 2; tile++) {
            ...
            // 1-Pixel Konturlinie auf dem vorderen Bergkamm
            if (isForeground) {
    ...
    render(ctx, width, height, t, state, stateTime, metrics) {
        ...
        // Sanft ausschwingender Beat-Puls für die Sonne (kein stuttriges Springen)
        ...
        // --- LAYER 3: COPPER SUN (Liegt hinter den Bergen und Wolken!) ---
        let sunR = Math.floor(minDim * 0.23); 
        let sx = Math.floor(width * 0.44); // Asymmetrische Verschiebung nach links
        ...
        // --- LAYER 4: ANTICS: MOUNTING CLOUD (Zieht vor der Sonne) ---
        ...
        // --- LAYER 5: PARALLAX MOUNTAINS (Kacheln nahtlos, klippen die Sonne!) ---
        // Kette 1 (Ferne - 4.8px/s)
        ...
        // --- LAYER 6: SHIMMERING HORIZON-GLOW (Direkt auf der Kante) ---
        ...
        for (let i = 0; i < numLines; i++) {
            ...
            // Hochfrequente water ripple Verformung bricht die "Leiter" auf
            ...
            // Zerstückeltes, organisches Glitzern statt starrem "Autobahn"-Mittelstreifen
