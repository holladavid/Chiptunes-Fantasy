...
export class AtariBobs {
    constructor() {
        ...
        grad.addColorStop(0.0, '#ffffff'); grad.addColorStop(0.2, '#99ff99'); grad.addColorStop(0.55, '#33ff33'); grad.addColorStop(0.85, '#005500'); grad.addColorStop(1.0, 'rgba(0, 10, 0, 0)'); 
        bCtx.fillStyle = grad; bCtx.beginPath(); bCtx.arc(cx, cy, this.bobSize / 2, 0, Math.PI * 2); bCtx.fill();
