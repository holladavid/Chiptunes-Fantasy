...
// Patched with CIA-1 ACK on
// Physical6502NMIFalling−EdgePinLatching
// SmartCIALatchDiscriminator
// 50HzFrameClockvsHigh−FreqSampleClock)
// Fixed4−BitNibblePitch−Stepping(
// D45F 1x speed fix for Giana Sisters)
// =========================================================
...
reset(loadAddr, prgCode, initAddr = 0, playAddr = 0) {
    ...
    for (let i = 0; i < safeNmiReturn.length; i++) {
        ...
        this.kernalRom[0x0A88 + i] = safeNmiReturn[i]; // Verschoben auf $EA88 (ausserhalb von $EA7E)
    }
